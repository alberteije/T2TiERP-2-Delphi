...
uses
  ...
  UCTe in 'Tela\UCTe.pas' {FCTe},
  UDataModuleCTe in '..\Comum\DataModule\UDataModuleCTe.pas' {FDataModuleCTe: TDataModule},
  UCTeDetalheAnexo in 'Tela\UCTeDetalheAnexo.pas' {FCTeDetalheAnexo},
  CteCabecalhoController in '..\..\Comum\Controller\CteCabecalhoController.pas',
...
begin
  ...
  Application.CreateForm(TFDataModuleCTe, FDataModuleCTe);
  Application.Run;
end.
