...
/// EXERCICIO
///  Analise a possibilidade de alterar essa janela para que seja possível o
///  usuário selecionar mais de um pagamento.
///  Analise o código da janela de pagamentos da NFC-e Desktop
